...
| [Project-Operations-Dashboard](Project-Operations-Dashboard) | | | Project Operations Dashboard through which customers can visualize the data in Power BI and can get insights from it |
